...
// Load subjects the student is enrolled in (for filter dropdown)
$stmt = $conn->prepare(
...
if ($subject_id > 0) {
    $stmt = $conn->prepare(
        "SELECT a.attendance_date, a.status, s.subject_name, s.subject_code
         FROM attendance a
...
<div class="box">
  ...
  <p style="color:gray;margin-top:12px;">
    If you don’t see records here, confirm you are enrolled in the subject and the teacher saved attendance for the chosen date.
  </p>
</div>
</body>
</html>
